// Top-level hash router + page shells, split out from main.jsx so that file is a
// pure bootstrap (createRoot/render) and this one exports components only —
// which is what react-refresh/only-export-components needs for Fast Refresh.
